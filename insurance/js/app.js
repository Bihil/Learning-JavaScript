...
// Everything realted to the quotation and calculations is Insurance
...
// Calculate the price for the current quoation
 ...
 */
 ...
 // Each the year the cost of insurance is going to be 3% cheaper
 price = price - ((difference * 3) * price) / 100;

 // Check the level of protection
 const level = insurance.level;

 price = this.calculatedLevel(price, level);
...
// Adds the value based on the value of protection
...
HTMLUI.prototype.showResults = function (price, insurance) {
 ...
 // Get make formthe object and assign a readable name
